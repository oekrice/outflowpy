...
Some example scripts are included in the directory `example scripts'.

Below is such a script to calculate and plot an outflow field with a dipolar lower boundary condition. Hopefully this should work "out of the box" and produce the below plot:

![Field line plot of a dipolar outflow field](example_plots/test1.png)
