...
def find_real_angle_distribution(eclipse_year, counter, doplots = True):
    ...
    plt.plot(rcs[1:], radial_distribution[1:], c = colors[counter%10], label = eclipse_year, linewidth = 2.0)

years = [2006,2008,2009,2010,2012,2013,2015,2016,2017,2019,2023,2024]

years = [2006,2009,2012,2015,2017,2023]

fig = plt.figure(figsize = (6.9, 4.0))

for yi, year in enumerate(years):
    find_real_angle_distribution(year, yi)
plt.legend()
plt.xlabel('Altitude ($R_\odot$)')
plt.ylabel('Avg. deviation from radial direction (radians)')
plt.tight_layout()
plt.savefig('9_radial_asheight.pdf')
plt.show()
plt.close()
