...
def find_eclipse_flines(eclipse_year, field_parameters):
    ...
    outflow_in = outflowpy.Input(input_map, nrho, rss, polynomial_type = 'exp', polynomial_coeffs = field_parameters)
...
def run_optimisation():
    ...
    es = cma.CMAEvolutionStrategy(initial_parameter_set, 0.01, {'verb_disp': 1})
