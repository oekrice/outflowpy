...
The package requires python>=3.9 on Linux or macOS>=14.0 or python>=3.12 on Windows. Older versions of macOS are not supported due to limitations of the Fortran compilers.
