...
Some example scripts are included in the directory `Examples', which should eventually cover all features of outflowpy.
...
See the 'API Reference' tab for how to modify these functions for your own use case.
